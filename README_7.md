...
This demo was built as part of a personal portfolio site exploring AI-powered browser capabilities. All three demos live in the same repo:

- **[emotion-detection-vitalscan-food-scanner](https://github.com/fitzsimonsb/emotion-detection-vitalscan-food-scanner)**
  - [AI Vision Emotion Detection](https://github.com/fitzsimonsb/emotion-detection-vitalscan-food-scanner/tree/main/emotion-detection) — real-time facial emotion classification, fully on-device
  - [VitalScan](https://github.com/fitzsimonsb/emotion-detection-vitalscan-food-scanner/tree/main/vitalscan) — optical PPG heart rate & blood pressure via phone camera
